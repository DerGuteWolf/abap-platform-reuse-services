CLASS zreusecl_fp_tmpl_store_client DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZREUSECL_FP_TMPL_STORE_CLIENT IMPLEMENTATION.
...
*        message = x2->get_text( ).
*        RAISE EXCEPTION TYPE zreusecx_fp_tmpl_store_error
*          EXPORTING
*            textid = zreusecx_fp_tmpl_store_error=>setup_not_complete.
*    ENDTRY.
  ENDMETHOD.
      ...
      if <schema> is assigned.
        ...
        raise EXCEPTION type zreusecx_fp_tmpl_store_error
          EXPORTING
            ...
            textid = zreusecx_fp_tmpl_store_error=>data_error.
      endif.
  ...
  METHOD set_form.
    ...
    try.
      ...
      lv_exists = abap_true.
    catch zreusecx_fp_tmpl_store_error into data(lo_data_error).
  ...
  METHOD __execute.
    try.
      ...
      RAISE EXCEPTION type zreusecx_fp_tmpl_store_error
        EXPORTING
          textid = zreusecx_fp_tmpl_store_error=>http_client_error
